...
class DecompilerFactory:
    ...
    def create_subprocess_based_decompiler(self, config):
        ...
        return decompiler_class(self.decompiler_name, self.sample_type, self.extension, nice, timeout,
    ...
    def create_library_based_decompiler(self, config):
        ...
        return decompiler_class(self.decompiler_name, self.sample_type, self.extension, self.version)
