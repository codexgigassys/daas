All files in the current folder were compiled based on the latest 2017 release of Just Decompile, without any modification to the original source files of that release.
